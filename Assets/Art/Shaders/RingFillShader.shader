Shader "Custom/CircleFillShader"
{
    Properties
    {
        ...
        _InnerTransparentRatio("Inner Transparent Ratio", Range(0, 1)) = 0.2 // Ratio of inner transparent part
    }
    SubShader
    {
        ...
        Pass
        {
            ...
            half4 frag(v2f i) : SV_Target
            {
                ...
                else if (dist <= _InnerTransparentRatio)
                {
                    color = half4(1, 1, 1, 0); // Transparent in the inner ratio part
                }
